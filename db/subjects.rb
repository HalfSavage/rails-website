...
module HalfSavageSubjectsModule
...
protected
  ...
  @@animals = %w{unicorn dog cat hampster emu ostrich starfish ape kitten cattle centipede cephalpod chameleon cheetah chickadee chicken chihuahua chimipanzee chinchilla dingo dinosaur Diplodocus Doberman\ pinscher puppy California\ sea\ lion camel buffalo capybera Canada\ goose Cape\ hunting\ dog caribou}
  ...
  @@related_person = %w{sister brother teacher doctor mom dad best\ friend neighbor child children classmate colleague co-worker companion baby best\ friend boy boyfriend bride bridegroom brother bud buddy manager bro homie lover neighbor newborn MMA\ opponent fuck-buddy preteen retiree rival roommate slave}
...
@@rooms = ['sexual arena', 'filthy wine cellar', 'urine-soaked murder alley','indoor meat smoker', 'improvised slaughterhouse', 'ballroom', 'basement', 'bathroom', 'bedroom', 'boardroom', 'boiler room', 'boudoir', 'breakfast nook', 'breakfast room', 'salesroom', 'salon', 'schoolroom', 'screen porch', 'scullery', 'showroom', 'sick room', 'sitting room', 'solarium', 'staff room', 'stateroom', 'stockroom', 'storeroom', 'studio', 'study', 'suite', 'sunroom', 'panic room', 'pantry', 'parlor', 'playroom', 'pool room', 'powder room', 'prison cell']
  ...
  @@places_proper = ['New York', 'Iowa', 'my hood', 'Compton', 'Western Canada', 'this lousy town', 'the ghetto', 'Hell', 'outer space', 'France', 'Germany', 'Detroit', 'Philadelphia', 'Atlanta', 'the middle of the Sahara Desert', 'Texas', 'Australia', '', 'Mongolia', 'San Francisco', 'Oakland', 'Planet Telezart', 'Florida']
  ...
  @@game_consoles = ['Colecovision', 'Nintendo64', 'Sega Dreamcast', 'SNES', 'GameBoy Color', 'Sega Master System', 'Neo-Geo', 'NES','XBox','XBox 360', 'Playstation 4', 'Wonder Swan', 'Vectrex', 'Nintendo 3DS', 'Turbografx-16', 'Sega Genesis', 'Super Nintendo', 'Gamecube', 'Wii']
...
class HalfSavageSubjects
  extend HalfSavageSubjectsModule
end 


#HalfSavageSubjects.test_subject_templates
